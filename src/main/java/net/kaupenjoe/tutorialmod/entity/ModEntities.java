...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<EchidnaEntity>> ECHIDNA =
            ENTITY_TYPES.register("echidna",
                    () -> EntityType.Builder.of(EchidnaEntity::new, MobCategory.CREATURE)
                            .sized(0.8f, 0.6f)
                            .build(new ResourceLocation(TutorialMod.MOD_ID, "echidna").toString()));
